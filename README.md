...
```
bash <(curl -s https://raw.githubusercontent.com/devrdxdev5/VPS-Deploy-For-Discord-1/refs/heads/main/install.sh)
```
OR

```
bash <(wget -qO- https://raw.githubusercontent.com/devrdxdev5/VPS-Deploy-For-Discord-1/refs/heads/main/install.sh)
```
